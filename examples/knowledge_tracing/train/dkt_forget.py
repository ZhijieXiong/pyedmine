...
from edmine.dataset.SequentialKTDataset import DKTForgetDataset
...
if __name__ == "__main__":
    ...
    global_params, global_objects = config_dkt_forget(params)
    ...
    global_objects["models"] = {
        "DKTForget": DKTForget(global_params, global_objects).to(global_params["device"])
    }
