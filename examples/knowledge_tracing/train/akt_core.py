...
from config.akt_core import config_akt_core
...
from edmine.model.sequential_kt_model.AKT_CORE import AKT_CORE
...
if __name__ == "__main__":
    ...
    global_params, global_objects = config_akt_core(params)
    ...
    global_objects["models"] = {
        "AKT_CORE": AKT_CORE(global_params, global_objects).to(global_params["device"])
    }
