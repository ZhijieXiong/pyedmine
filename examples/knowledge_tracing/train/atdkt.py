...
if __name__ == "__main__":
    ...
    parser.add_argument("--IK_start", type=int, default=20)
    parser.add_argument("--w_QT_loss", type=float, default=0.1)
    parser.add_argument("--w_IK_loss", type=float, default=0.1)
    # 其它
