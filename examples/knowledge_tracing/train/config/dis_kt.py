...
from edmine.config.data import config_q_table, config_dis_kt_dataset
...
def config_dis_kt(local_params):
    model_name = "DisKT"
    ...
    config_dis_kt_dataset(local_params, global_params)
    ...
    global_params["models_config"] = {
        model_name: {
            ...
            "predictor_config": {
                ...
                "dim_predict_in": local_params["dim_model"] + local_params["dim_model"] * 2,
