...
def config_routerkt(local_params):
    model_name = "RouterKT"
    ...
    global_params["models_config"] = {
        model_name: {
            ...
            "num_shared_heads": local_params["num_shared_heads"],
            "num_selected_heads": local_params["num_selected_heads"],
            ...
            "predictor_config": {
                ...
                "dim_predict_in": local_params["dim_model"] * 2,
