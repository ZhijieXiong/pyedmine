...
def config_qikt(local_params):
    ...
    global_params["loss_config"] = {
        "q all loss": local_params["weight_predict_q_all_loss"],
        "q next loss": local_params["weight_predict_q_next_loss"],
        "c all loss": local_params["weight_predict_c_all_loss"],
        "c next loss": local_params["weight_predict_c_next_loss"]
    }
