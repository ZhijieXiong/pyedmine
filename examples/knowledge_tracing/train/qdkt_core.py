...
from config.qdkt_core import config_qdkt_core
...
from edmine.model.sequential_kt_model.qDKT_CORE import qDKT_CORE
...
if __name__ == "__main__":
    ...
    global_params, global_objects = config_qdkt_core(params)
    ...
    global_objects["models"] = {
        "qDKT_CORE": qDKT_CORE(global_params, global_objects).to(global_params["device"])
    }
