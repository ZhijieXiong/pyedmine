...
from config.ukt import config_ukt
from utils import auto_clip_seq

from edmine.utils.parse import str2bool
from edmine.utils.use_torch import set_seed
from edmine.utils.log import get_now_time
from edmine.dataset.SequentialKTDataset import UKTDataset
...
if __name__ == "__main__":
    ...
    global_params, global_objects = config_ukt(params)
    ...
    if params["auto_clip_seq"]:
        ...
        collate_fn = None
    dataset_train = UKTDataset(global_params["datasets_config"]["train"], global_objects)
    dataloader_train = DataLoader(dataset_train, batch_size=params["train_batch_size"], shuffle=True, collate_fn=collate_fn)
    dataset_valid = UKTDataset(global_params["datasets_config"]["valid"], global_objects)
    ...
    global_objects["models"] = {
        "UKT": UKT(global_params, global_objects).to(global_params["device"])
    }
