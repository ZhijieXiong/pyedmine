...
def config_a2c(local_params):
    ...
    config_optimizer(local_params, global_params, "concept_actor")
    config_optimizer(local_params, global_params, "concept_critic")
    config_optimizer(local_params, global_params, "question_actor")
    config_optimizer(local_params, global_params, "question_critic")
